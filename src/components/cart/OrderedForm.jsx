...
export const OrderedForm = () => {
    ...
    return (
        <>
            {isSuccessOtp ?
                <div className=''>
                    <OtpInput value={otp} separator={<span>-</span>}  onChange={handleChange} numInputs={6} />
                        ...
                        formik => {
                            return (
                                <Form className='flex flex-col gap-6'>
                                    <FormControl control={"input"} name={"username"} label={"Username"} placeholder={"Enter username"} />
                                    <FormControl control={"input"} name={"email"} label={"Enter email"} placeholder={"Enter Email name"} />
                                    <FormControl control={"password"} name={"password"} label={"Password"} placeholder={"Enter password"} />
                                    <FormControl control={"password"} name={"confirmPassword"} label={"Check password"} placeholder={"Check password"} />                            <div className='flex justify-end'>
                                        <button disabled={!formik.isValid || formik.isSubmitting} className='bg px-4 py-2 rounded disabled:opacity-50 disabled:cursor-not-allowed' type='submit' variant="gradient" color="green">
                                            <span>Jo'natish</span>
                                        </button>
                                    </div>
                                </Form>
