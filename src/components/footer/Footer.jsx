    ...
    <div className="bg-blue-50 pt-20 border-t pb-10">
      <div className="main-container bg-transparent grid col-span-1 md:grid-cols-4  xl:grid-cols-3  gap-20">
        <ul className="sm:col-span-2 xl:col-span-1">
          ...
          />
          <li className="py-1">
            <Link to={"/biz-haqimizda"}>About me</Link>
          </li>
          <li className="py-1">
        ...
        <ul className="sm:col-span-2 xl:col-span-1">
          <h1 className="text-2xl font-semibold mb-1">Communication</h1>
          <li className="py-1">
            <span className="mr-3">Addres:</span>
        ...
        <ul className="sm:col-span-2 xl:col-span-1">
          <h1 className="text-2xl font-semibold mb-1">Social networks</h1>
